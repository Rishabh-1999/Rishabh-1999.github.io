    ...
    const Output = (isModal = false) => {
      ...
      return (
        <>
          ...
          <h3 className="text-[1.3rem] group-hover:underline">{position}</h3>
          <a
            href={companyLink}
            target="_blank"
            rel="noreferrer"
...
function WorkExperiencePage() {
  return (
    ...
    >
      <Heading heading="Work Experience" subHeading="Experience I gathered" />

      <div className="max-w-5xl mx-6 my-4 pb-4 flex lg:flex-row lg:space-x-6 md:space-x-4 md:space-y-0 space-y-4 flex-col justify-start overflow-x-auto snap-x snap-mandatory scrollbar scrollbar-track-[#2a2a2a] scrollbar-thumb-highlightColor">
