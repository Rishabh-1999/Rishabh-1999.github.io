...
function Heading({ heading, subHeading }: HeadingProps): JSX.Element {
  return (
    <div className="my-5 mx-4 flex flex-col flex-shrink-0 flex-grow-0 justify-center items-center text-heading">
      ...
      {subHeading && (
        <h3 className="relative before:content-[''] before:absolute before:block before:top-1/2 before:w-full before:h-1 before:border-t-[3px] before:border-solid before:border-[var(--layout-color-highlight)] before:z-[1] text-subHeading">
