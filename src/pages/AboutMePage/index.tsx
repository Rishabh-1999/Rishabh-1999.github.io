      ...
      <div className="md:mx-auto mx-2 lg:px-4 px-2 pt-4 section_content">
        <div className="flex md:flex-row flex-col">
          ...
          <div className="md:mt-7 mt-3 md:pr-5 font-architects-daughter flex-1 text-1.5xl text-justify leading-snug right">
            ...
            <span>Software Engineer - II (Full Stack) @ Autodesk.</span>
            <br />
            I've been interested in tech since my 8th, when I got my first
            lesson on HTML. My journey of curiosity and making things more
            easier and solve through tech started from there. I always wanted to
            learn how things work around in the background and make something
            that will change the course of our life, that inspires me a lot. I
            wanted to work in an environment where we do from scratch by
            questing everything&nbsp;
            <span>'why and how should we do'</span>, that constant question of
            once own idea to make things better, that is what I want to go for,
            that's why I wanted to work on start-up where we do things from the
            bottom line and in a matter of time, boom!, a massive product. That
            is what I want to go for.
            <br />
